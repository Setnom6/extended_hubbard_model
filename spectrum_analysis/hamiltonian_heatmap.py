...
HProjected = dqd.getHamiltonianInBase(dqd.basesNames[BasesNames.SINGLET_TRIPLET_QUBIT_VALLEY_MINUS.value])
sector_sizes = dqd.basesSectors[BasesNames.SINGLET_TRIPLET_QUBIT_VALLEY_MINUS.value]
