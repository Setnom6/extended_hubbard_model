"""
Script for plotting eigenvalues colored by bipartition (symmetry) using plot_eigenvalues_bipartition.
...
from src.plottingMethods import plot_eigenvalues_bipartition, setupLogger
...
# Choose basis and split value for bipartition
basis_name = dqd.basesNames[BasesNames.SIMMETRIC_ANTISYMMETRIC.value]
split_value = dqd.basesSectors[BasesNames.SIMMETRIC_ANTISYMMETRIC.value]["Symmetric"]  # As the symmetric are the first ones (we could hardoced 18)

# Plot and save
fig, ax = plot_eigenvalues_bipartition(
